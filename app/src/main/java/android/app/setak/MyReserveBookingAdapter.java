...
public class MyReserveBookingAdapter extends BaseAdapter {
    Context context;
    ArrayList<Order> list_itemArrayList;
    ViewHolder viewHolder;
    String setakList, setakState;

    public MyReserveBookingAdapter(ArrayList<Order> list_itemArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.myreserve_booking_item, null);

            viewHolder = new ViewHolder();
            viewHolder.myreserve_setakName = (TextView) convertView.findViewById(R.id.myreserve_setakName);
            viewHolder.myreserve_setakInDate = (TextView) convertView.findViewById(R.id.myreserve_setakInDate);
            viewHolder.myreserve_setakPrice = (TextView) convertView.findViewById(R.id.myreserve_setakPrice);
            viewHolder.myreserve_setakState = (TextView) convertView.findViewById(R.id.myreserve_setakState);
